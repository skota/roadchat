...
config :roadchat, RoadchatWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "OMTDqKiuaD4iBf3hvGu5+BpLrgk/slyfIslfjgOjoZOQwCHdQAjUrU/xupnivpwQ",
  watchers: [
...
config :roadchat, RoadchatWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/roadchat_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :roadchat, dev_routes: true
